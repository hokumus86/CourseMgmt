...
public class AdminFrame extends JFrame {
	...
	protected void btnSave_Action_PerFormed() {
		if(txtUserName.getText().equals("")) {
			JOptionPane.showMessageDialog(AdminFrame.this, "Kullan�c� Ad� Bo� Ge�ilemez!!!");
			return;
		}
		if(txtPassword.getText().equals("")) {
			JOptionPane.showMessageDialog(AdminFrame.this, "Sifre Bo� Ge�ilemez!!!");
			return;
		}
		UserModelDao dao = new UserModelDao();
